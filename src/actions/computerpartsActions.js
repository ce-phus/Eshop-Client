...
export const getComputerPartsList = () => async (dispatch) => {
    try {
        ...
        // call api
        const { data } = await axios.get("https://cephuseshop.co.ke/api/computerparts/", {
            method: 'POST',
            mode: 'cors',
            headers:{
...
export const getComputerPartsDetails = (id) => async (dispatch) =>{
    try {
        ...
        // call api
        const { data } = await axios.get(`https://cephuseshop.co.ke/api/computerparts/${id}/`)
        dispatch({
...
export const createcomputerparts = (parts) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(
            "https://cephuseshop.co.ke/api/computerparts-create/",
            parts,
            config
        )
...
export const deletecomputerparts = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.delete(
            `https://cephuseshop.co.ke/api/computerparts-delete/${id}/`,
            config
        )
...
export const updatecomputerparts = (id, parts) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(
            `https://cephuseshop.co.ke/api/computerparts-update/${id}/`,
            parts,
            config
        )
